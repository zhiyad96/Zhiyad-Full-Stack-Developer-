...
//     desc: "Developing and maintaining full-stack web applications using Python, Django, Django-RestFramework and modern frontend frameworks like React and Next.js. Focused on building scalable APIs and delivering clean solutions.",
//     achievements: [
...
//   return (
//     <section ref={container} className="h-screen w-full bg-[#050505] flex items-center justify-center px-6 ">
...
<section
  ref={container}
  className="relative z-10 h-screen w-full bg-[#050505] flex items-center justify-center px-6 md:px-20"
>      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
