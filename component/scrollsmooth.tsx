...
//     // Project Image Hover (The Lens)
//     const handleProjectHover = () => {
//       gsap.to(dot, { scale: 0, opacity: 0, duration: 0.2 });
//       gsap.to(ring, {
//         scale: 2.2, // Reduced from 4.0 - looks much more premium
...
export default function SmoothScroll() {
  ...
  useEffect(() => {
    const lenis = new Lenis({
      ...
      touchMultiplier: 0.5, // Makes touch scrolling feel more responsive
      infinite: false,
